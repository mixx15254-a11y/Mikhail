...
SEASONS = [
    ...
    },
    {
        ...
        "leagues": [
            ...
            {
                "name": "2016-2017 ВЫСШАЯ ЛИГА 5×5",
                "format": "5×5",
                "double": False,
                "start": "2016-09-04",
                "time": "16:00",
...
def create_league_sheet(wb, league, season_name):
    ...
    ws.row_dimensions[row].height = 20
    # Set column widths for schedule: A small, B date, etc.
    header_row = row
    row += 1
    # Group by tour for visual blocks
    current_round = None
    ...
    # Also set for teams section columns already but ensure good
